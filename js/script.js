...
/*  =============================================
    ...
    function applyThemeFromStorage(bgColor) {
        ...
        const themes = {
            ...
            "#E73131": { "--primary-color": "#E73131" }, "#4F46E5": { "--primary-color": "#4F46E5" },

            "#059669": { "--primary-color": "#059669" }, "#D67FAF": { "--primary-color": "#D67FAF" },
        ...
        Object.keys(selectedTheme).forEach(function (variable) {
